  ...
  return (
    ...
    >
      ...
      <Text
        ...
        whiteSpace="pre-wrap"
        children="Login"
        {...getOverrideProps(overrides, "Login34902664")}
      ></Text>
      <Text
        fontFamily="Kameron"
        fontSize="16px"
      ...
      >
        <View
          ...
          padding="0px 0px 0px 0px"
          backgroundColor="rgba(77,0,0,1)"
          {...getOverrideProps(overrides, "Rectangle 1188")}
        ></View>
        <View
          width="1px"
          height="730px"
          ...
          padding="0px 0px 0px 0px"
          backgroundColor="rgba(77,0,0,1)"
          {...getOverrideProps(overrides, "Rectangle 1189")}
        ></View>
        <View
          width="315px"
          height="309px"
          ...
          overflow="hidden"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "undraw_access_account_re_8spm 1")}
        >
          <Icon
