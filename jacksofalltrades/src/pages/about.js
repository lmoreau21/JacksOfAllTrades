            ...
            <div style={{textAlign: "center"}}>
                ...
                <div style={{textAlign: "left", paddingLeft: "22px", paddingRight: "22px", fontSize: "20px", wordWrap: "normal"}}> 
                    ...
                    <p> Learning new skills can be a difficult task without the proper resources. Many services out there are overly complicated, time consuming, and may charge hidden fees. 
                        ...
                        pen tricks, tie a tie, juggle, ASL alphabet, morse code, chess, and many more. We plan on using Figma to design a website and AWS to host a React application. By using MySQL 
                        Databases stored on the cloud, we can easily store and read needed information and take measures to secure it as well. We will be using Atlassian Jira to track the progress of 
                        our project and GitHub for code sharing. Lastly, we will use YouTube to embed instructional videos as part of the website with proper credit.
                    </p>
